		...
		*/
		...
		/*
			...
			Parameters:  	1) A pointer to a Text variable, containing the title of the movie
							2) An integer containing the year the movie was released
							3) A pointer to a Text variable, containing the genre of the movie
							4) A pointer to a Text variable, containing the rating of the movie
							5) A float containing the IMDB rating of the movie (out of 10 stars)
